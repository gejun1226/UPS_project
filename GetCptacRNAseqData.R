...
GetCptacRNAseqData <- function(folder_name="gdc_download_20190912_063254.707570", annofile_name = "gdc_sample_sheet.2019-09-12.tsv",path="/Users/junge/Desktop/UPS/mass_data/UCEC_FBXW7/RNA_seq/HTSeq_FPKM",type="FPKM"){
  setwd(path)
